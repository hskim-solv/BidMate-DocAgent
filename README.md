...
- **평가셋**: 공개 synthetic n=40 (single_doc 14 / comparison 10 / follow_up 9 / abstention 7). 비공개 RFP eval은 [ADR 0005](docs/adr/0005-eval-split-public-synthetic-private-local.md)에 따라 분리합니다.
...
| System | Latency (p50/p95) | p50 1.1ms / p95 2.3ms |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| naive_baseline | naive_baseline | 4 | off | off | off | 0.844 | 0.700 | 0.500 | 0.974 | 0.650 | 0.125 | 0.000 | 2.3ms |
...
| no_metadata_first | agentic_full | auto | off | on | on | 0.812 | 0.850 | 0.662 | 0.935 | 0.850 | 1.000 | 0.000 | 2.6ms |
| no_rerank | agentic_full | auto | on | off | on | 0.875 | 0.900 | 0.887 | 0.969 | 0.900 | 1.000 | 0.325 | 2.9ms |
