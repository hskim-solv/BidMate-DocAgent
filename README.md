...
데모 UI는 3개 pipeline preset(`naive_baseline` · `agentic_full` · `agentic_full_llm`)을 라디오 버튼으로 전환하고, 같은 질의에 대한 **extractive vs LLM 합성(ADR 0007)** 답변을 side-by-side로 비교합니다. 모든 claim은 evidence chunk_id로 추적 가능하며, abstention 케이스(예: `기관 A의 양자암호 적용 방안은?`)는 🔴 insufficient status로 명시되어 *근거 부족을 정직하게 인정*합니다.
...
| System | Latency (p50/p95) | p50 1.9ms / p95 8.3ms |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| naive_baseline | naive_baseline | 4 | off | off | off | 0.844±0.12 | 0.714±0.14 | 0.512±0.12 | 0.974±0.05 | 0.667 | 0.300 | 0.000 | 8.3ms |
| full | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 3.1ms |
| full_llm | agentic_full_llm | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 3.4ms |
