...
- **헤드라인 latency 기준 preset**: 위 요약표 `System | Latency` 행(p50 1.7ms / p95 5.3ms)은 **`naive_baseline` (hashing backend)** 기준 측정값입니다. `agentic_full_llm`은 API 기본값이지만 walltime이 LLM 서비스 레이턴시를 포함해 환경 의존적이므로 CI에서 고정하지 않습니다. 파이프라인별 latency는 Ablation comparison 표의 `Latency p95` 컬럼을 참고하세요.
...
| System | Latency (p50/p95) | p50 1.7ms / p95 5.3ms (`naive_baseline`, hashing — CI source of truth) |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| naive_baseline | naive_baseline | 4 | off | off | off | 0.844±0.12 | 0.714±0.14 | 0.512±0.12 | 0.974±0.05 | 0.667 | 0.300 | 0.000 | 5.3ms |
| full | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.6ms |
| full_llm | agentic_full_llm | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.5ms |
| full_llm_metadata | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.4ms |
...
| full_reranker | agentic_full | auto | on | on | on | 0.906±0.12 | 0.929±0.07 | 0.905±0.08 | 1.000±0.00 | 0.905 | 1.000 | 0.310 | 4.5ms |
