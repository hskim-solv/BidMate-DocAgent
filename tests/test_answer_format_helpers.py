...
def test_make_citation_defaults_missing_chunk_id_to_empty() -> None:
    citation = make_citation({"doc_id": "rfp-001"})

    assert citation["chunk_id"] == ""


def test_make_citation_defaults_missing_doc_id_to_empty() -> None:
    citation = make_citation({"chunk_id": "chunk-7"})
...
def test_make_citation_defaults_missing_section_to_empty() -> None:
    citation = make_citation({"doc_id": "rfp-001", "chunk_id": "chunk-7"})
