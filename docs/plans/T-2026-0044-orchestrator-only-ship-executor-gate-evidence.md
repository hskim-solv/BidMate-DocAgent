# Plan: T-2026-0044 Orchestrator-only ship-executor + gate evidence

- Status: draft
- Owner role: Implementer -> Deep Reviewer -> Reviewer
- Related task: `tasks/queue.md::T-2026-0044`
...
- Owner role: `Implementer -> Deep Reviewer -> Reviewer`
- Queue title: Orchestrator-only ship-executor + gate evidence
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0044
git diff --check
```
...
- Files touched: docs/plans/T-2026-0044-orchestrator-only-ship-executor-gate-evidence.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0044
