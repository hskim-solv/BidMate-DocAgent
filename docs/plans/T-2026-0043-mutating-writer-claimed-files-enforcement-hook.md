# Plan: T-2026-0043 Mutating-writer + claimed-files enforcement hook

- Status: draft
- Owner role: Implementer -> Reviewer
- Related task: `tasks/queue.md::T-2026-0043`
...
- Owner role: `Implementer -> Reviewer`
- Queue title: Mutating-writer + claimed-files enforcement hook
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0043
git diff --check
```
...
- Files touched: docs/plans/T-2026-0043-mutating-writer-claimed-files-enforcement-hook.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0043
