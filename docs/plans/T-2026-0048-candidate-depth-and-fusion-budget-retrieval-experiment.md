# Plan: T-2026-0048 Candidate-depth and fusion-budget retrieval experiment

- Status: draft
- Owner role: Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer
- Related task: `tasks/queue.md::T-2026-0048`
...
- Owner role: `Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer`
- Queue title: Candidate-depth and fusion-budget retrieval experiment
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0048
git diff --check
```
...
- Files touched: docs/plans/T-2026-0048-candidate-depth-and-fusion-budget-retrieval-experiment.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0048
