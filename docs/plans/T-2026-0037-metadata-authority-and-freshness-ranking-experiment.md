# Plan: T-2026-0037 Metadata, authority, and freshness ranking experiment

- Status: draft
- Owner role: Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer
- Related task: `tasks/queue.md::T-2026-0037`
...
- Owner role: `Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer`
- Queue title: Metadata, authority, and freshness ranking experiment
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0037
git diff --check
```
...
- Files touched: docs/plans/T-2026-0037-metadata-authority-and-freshness-ranking-experiment.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0037
