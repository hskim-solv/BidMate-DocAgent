# Plan: T-2026-0035 Prompt-injection and data boundary guardrail

- Status: draft
- Owner role: Security Reviewer -> Implementer -> Privacy Auditor -> Reviewer
- Related task: `tasks/queue.md::T-2026-0035`
...
- Owner role: `Security Reviewer -> Implementer -> Privacy Auditor -> Reviewer`
- Queue title: Prompt-injection and data boundary guardrail
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0035
git diff --check
```
...
- Files touched: docs/plans/T-2026-0035-prompt-injection-and-data-boundary-guardrail.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0035
