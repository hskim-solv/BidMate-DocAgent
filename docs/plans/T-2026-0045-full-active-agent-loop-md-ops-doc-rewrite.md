# Plan: T-2026-0045 Full active-agent-loop.md ops-doc rewrite

- Status: draft
- Owner role: Implementer -> Reviewer
- Related task: `tasks/queue.md::T-2026-0045`
...
- Owner role: `Implementer -> Reviewer`
- Queue title: Full active-agent-loop.md ops-doc rewrite
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0045
git diff --check
```
...
- Files touched: docs/plans/T-2026-0045-full-active-agent-loop-md-ops-doc-rewrite.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0045
