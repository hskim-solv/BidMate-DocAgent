# Plan: T-2026-0036 Abstention, conflict, and freshness calibration

- Status: draft
- Owner role: Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer
- Related task: `tasks/queue.md::T-2026-0036`
...
- Owner role: `Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer`
- Queue title: Abstention, conflict, and freshness calibration
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0036
git diff --check
```
...
- Files touched: docs/plans/T-2026-0036-abstention-conflict-and-freshness-calibration.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0036
