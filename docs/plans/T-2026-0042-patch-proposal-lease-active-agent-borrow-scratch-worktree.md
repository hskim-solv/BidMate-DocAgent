# Plan: T-2026-0042 Patch-proposal + lease active_agent borrow + scratch worktree

- Status: draft
- Owner role: Implementer -> Reviewer
- Related task: `tasks/queue.md::T-2026-0042`
...
- Owner role: `Implementer -> Reviewer`
- Queue title: Patch-proposal + lease active_agent borrow + scratch worktree
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0042
git diff --check
```
...
- Files touched: docs/plans/T-2026-0042-patch-proposal-lease-active-agent-borrow-scratch-worktree.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0042
