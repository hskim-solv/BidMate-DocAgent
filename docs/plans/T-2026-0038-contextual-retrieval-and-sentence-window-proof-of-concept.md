# Plan: T-2026-0038 Contextual retrieval and sentence-window proof of concept

- Status: draft
- Owner role: Planner -> Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer
- Related task: `tasks/queue.md::T-2026-0038`
...
- Owner role: `Planner -> Implementer -> Benchmark Auditor -> Privacy Auditor -> Reviewer`
- Queue title: Contextual retrieval and sentence-window proof of concept
...
```bash
python3 scripts/agent_loop.py handoff-check --task T-2026-0038
git diff --check
```
...
- Files touched: docs/plans/T-2026-0038-contextual-retrieval-and-sentence-window-proof-of-concept.md
...
- Next safe command: python3 scripts/agent_loop.py handoff-check --task T-2026-0038
