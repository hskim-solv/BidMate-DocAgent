...
- [Retrieval hardening milestone](./retrieval/retrieval-hardening.md)
- [Grounding/eval hardening](./eval/grounding-eval-hardening.md)
- [Planner & query-rewrite trace schema](./agentic/planner-trace.md)
- [Reproducible harness](./operations/harness.md)
- [Ablation results](./eval/ablation-results.md)
