...
| [0033](./0033-multihop-cross-section-eval-slice.md) | accepted | Multi-hop cross-section eval slice를 직교 saturation falsifier로 |
...
| [0074](./0074-rfp-rag-stage-separation.md) | proposed | RFP RAG 단계 분리 — `naive_baseline`, retrieval improvements, answer evaluation, agentic paths, demo/API defaults 를 분리하고 ADR 0002/0024/0058 의 default 해석을 정정 |
